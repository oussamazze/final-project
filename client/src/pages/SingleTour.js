...
import { getRelatedTours, getTour, addComment } from "../redux/features/tourSlice";
...
const SingleTour = () => {
  ...
  useEffect(() => {
    setComments(tour?.comments || []);
    console.log("Commentaires récupérés :", tour?.comments || []);
  }, [tour?.comments]);
  ...
  comments.map((comment) => (
    <MDBCard key={comment._id} className="mt-2 p-2">
